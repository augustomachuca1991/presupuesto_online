...
export const LogoVictor = ({ textColor = "#2c2c2a", subtextColor = "#5f5e5a", classCustom = "" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="46" fill="none" className={classCustom}>
      <path
        fill="#863bff"
      ...
      <g mask="url(#a)">
        <g filter="url(#b)">
          <ellipse cx="5.508" cy="14.704" fill="#ede6ff" rx="5.508" ry="14.704" style={{ fill: "#ede6ff", fillOpacity: 1 }} transform="matrix(0 1 1 0 -4.47 31.516)" />
        </g>
        <g filter="url(#c)">
          <ellipse cx="10.399" cy="29.851" fill="#ede6ff" rx="10.399" ry="29.851" style={{ fill: "#ede6ff", fillOpacity: 1 }} transform="matrix(0 1 1 0 -39.328 7.883)" />
        </g>
        <g filter="url(#d)">
          <ellipse cx="5.508" cy="30.487" fill="#7e14ff" rx="5.508" ry="30.487" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(90 -25.913 -14.639)scale(1 -1)" />
        </g>
        <g filter="url(#e)">
          <ellipse cx="5.508" cy="30.599" fill="#7e14ff" rx="5.508" ry="30.599" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(90 -32.644 -3.334)scale(1 -1)" />
        </g>
        <g filter="url(#f)">
          <ellipse cx="5.508" cy="30.599" fill="#7e14ff" rx="5.508" ry="30.599" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="matrix(0 1 1 0 -34.34 30.47)" />
        </g>
        <g filter="url(#g)">
          <ellipse cx="14.072" cy="22.078" fill="#ede6ff" rx="14.072" ry="22.078" style={{ fill: "#ede6ff", fillOpacity: 1 }} transform="rotate(93 24.506 48.493)scale(-1 1)" />
        </g>
        <g filter="url(#h)">
          <ellipse cx="3.47" cy="21.501" fill="#7e14ff" rx="3.47" ry="21.501" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(89 28.708 47.59)scale(-1 1)" />
        </g>
        <g filter="url(#i)">
          <ellipse cx="3.47" cy="21.501" fill="#7e14ff" rx="3.47" ry="21.501" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(89 28.708 47.59)scale(-1 1)" />
        </g>
        <g filter="url(#j)">
          <ellipse cx=".387" cy="8.972" fill="#7e14ff" rx="4.407" ry="29.108" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(40 .387 8.972)" />
        </g>
        <g filter="url(#k)">
          <ellipse cx="47.523" cy="-6.092" fill="#7e14ff" rx="4.407" ry="29.108" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(38 47.523 -6.092)" />
        </g>
        <g filter="url(#l)">
          <ellipse cx="41.412" cy="6.333" fill="#47bfff" rx="5.971" ry="9.665" style={{ fill: "#47bfff", fillOpacity: 1 }} transform="rotate(38 41.412 6.333)" />
        </g>
        <g filter="url(#m)">
          <ellipse cx="-1.879" cy="38.332" fill="#7e14ff" rx="4.407" ry="29.108" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(38 -1.88 38.332)" />
        </g>
        <g filter="url(#n)">
          <ellipse cx="-1.879" cy="38.332" fill="#7e14ff" rx="4.407" ry="29.108" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(38 -1.88 38.332)" />
        </g>
        <g filter="url(#o)">
          <ellipse cx="35.651" cy="29.907" fill="#7e14ff" rx="4.407" ry="29.108" style={{ fill: "#7e14ff", fillOpacity: 1 }} transform="rotate(38 35.651 29.907)" />
        </g>
        <g filter="url(#p)">
          <ellipse cx="38.418" cy="32.4" fill="#47bfff" rx="5.971" ry="15.297" style={{ fill: "#47bfff", fillOpacity: 1 }} transform="rotate(38 38.418 32.4)" />
        </g>
      </g>

      {/* Las props inyectan el color directamente aquí */}
      <text
        x="64"
        y="21"
        fill={textColor}
